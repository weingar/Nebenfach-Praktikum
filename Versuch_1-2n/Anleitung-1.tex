...
\etodo{\textbf{Praktikumsleitung:} Halbleiter Solarzellen könnten durch Grätzelzellen, i.e. Farbstoff-basierte Solarzellen, ersetzt werden. Ein Versuchsset im Lager vorhanden.}
...
\subsubsection{$pn$-Übergang mit äußerer Spannung in Sperrrichtung}
...
\begin{hint}
	Bei diesem Versuch ist es besonders wichtig, vor Versuchsbeginn zu testen, ob die Sicherungen der mA-Eingänge der Multimeter funktionieren. \\
	Wenn kein Strom durch die Solarzelle fließt, ist meistens eine Sicherung kaputt. In über acht Jahren war noch nie eine Solarzelle oder ein Netzgerät das Problem!
\end{hint}

\begin{figure}[h]
	\centering
	\input{Abbildungen/Solarzelle_Messung_tikz.tex}
