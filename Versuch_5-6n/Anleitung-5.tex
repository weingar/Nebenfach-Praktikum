...
\etodo{\textbf{Praktikumsleitung:} Die Schrittmotoren für die angeregten Schwingungen haken manchmal bei kleinen Frequenzen, einfach von Hand kurz anschieben. Die Winkelmesser machen ab und an Probleme. Jörn Große-Knetter ist der Experte.}
...
\begin{itemize}
	...
	\item Das ROOT-Makro, welches die pdf-Files erzeugt, fittet eine Kosinus-förmige Schwingung an die Daten. Das geht besser, wenn die Messung neu gestartet wird, nachdem der Einschwingvorgang komplett abgeklungen ist, d.h. die Amplitude der angeregten Schwingung zeitlich relativ konstant ist. Dann reicht es, fünf bis zehn komplette Schwingungen aufzuzeichnen und dann die Messung zu beenden. Das Makro läuft dann relativ schnell durch.
\end{itemize}
}
